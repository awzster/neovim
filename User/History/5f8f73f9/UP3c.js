...
angular.module('app').service('gridOptionsService', function($http, $q, $timeout, $filter, calcService, rendererService)
{
  ...
  this.init = (ctrl) =>
  {
    ...
    IsCustomHeader.prototype.init = function(params)
    {
      ...
      title.innerHTML = 'Custom<br/>description';

      const controls = document.createElement('div');
      controls.className = 'override-controls';

      const btnOn = document.createElement('button');
      btnOn.tOverrideOverrideOverrideOverrideOverrideype = 'button';
    ...
    const editableCellClass = ({ data }) =>
    {
      return (data && data.is_custom == '1') ? [ 'editable-cell'] : [ 'blocked-cell'];
    }
    ...
    const columnDefs = [
      ...
      { headerName: 'Commercial Description', field: 'erp_name', flex: 2, type: 'nameCol', editable: isCellEditable, cellClass: editableCellClass },
      { headerName: 'ERP Description', field: 'commercial_name', flex: 2, type: 'nameCol', editable: isCellEditable, cellClass: editableCellClass },
