...
angular.module('app').service('gridOptionsService', function($http, $q, $timeout, $filter, calcService, rendererService)
{
  ...
  this.init = (ctrl) =>
  {
    ...
    const columnDefs = [
      ...
      { headerName: 'Commercial Description', field: 'erp_name', flex: 2, type: 'nameCol', editable: true, cellClass: [ 'editable-cell' ] },
      { headerName: 'ERP Description', field: 'commercial_name', flex: 2, type: 'nameCol', editable: true, cellClass: [ 'editable-cell' ] },
