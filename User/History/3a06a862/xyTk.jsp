...
<%
  ...
  try
  {
    ...
    {
      sb.append(ds.getObject("call cf2.tree_node_get(:userId, :compCode, :id)", userId, compCode, request));
    }
    ...
    else if (dtType.equals("moveSubmit"))
    {
      ds.Update("call cf2.tree_node_move(:userId, :compCode, '" + ip + "', :tree_id, :source, :target)", userId, compCode, request);
    }
    else if (dtType.equals("treeSubmit"))
    {
      ds.Update("call cf2.tree_upd(:userId, :compCode, '" + ip + "', :id, :name, :typeOf)", userId, compCode, request);
    }
